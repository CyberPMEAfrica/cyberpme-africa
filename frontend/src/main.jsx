...
function App() {
  ...
  async function loadData() {
    try {
      ...
      setServers(await serverResponse.json()); setAlerts(await alertResponse.json()); setError("");
  ...
  return <main>
    <header><div className="brand"><b>CA</b><div><strong>CyberPME</strong><small>AFRICA</small></div></div><button onClick={loadData}>Actualiser</button></header>
    ...
    <section className="servers"><div className="title"><div><p className="eyebrow">INFRASTRUCTURE</p><h2>Serveurs</h2></div><small>Mise à jour toutes les 10 secondes</small></div>
